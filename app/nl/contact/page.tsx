            ...
            {status === "success" ? (
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <p className="font-mono text-xs text-muted tracking-widest uppercase">Verzonden</p>
                </div>
                <h2 className="text-3xl font-bold tracking-tighter text-primary mb-4">
                  Bericht ontvangen.
                </h2>
                <p className="text-secondary leading-relaxed max-w-md">
                  Ik kom binnen 24 uur bij je terug. Tot snel!
                </p>
              </motion.div>
            ) : (
              <motion.form
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div className="flex flex-col gap-2">
                    <label htmlFor="contact-name-nl" className="font-mono text-xs text-muted tracking-widest uppercase">Naam</label>
                    <input
                      id="contact-name-nl"
                      type="text"
                      name="name"
                  ...
                  <div className="flex flex-col gap-2">
                    <label htmlFor="contact-email-nl" className="font-mono text-xs text-muted tracking-widest uppercase">E-mail</label>
                    <input
                      id="contact-email-nl"
                      type="email"
                      name="email"
                ...
                <div className="flex flex-col gap-2">
                  <label htmlFor="contact-company-nl" className="font-mono text-xs text-muted tracking-widest uppercase">Bedrijf</label>
                  <input
                    id="contact-company-nl"
                    type="text"
                    name="company"
                    autoComplete="organization"
                    className="input-line"
                    placeholder="Bedrijfsnaam B.V. (optioneel)"
                    disabled={status === "loading"}
                  />
                </div>

                <div className="flex flex-col gap-2">
                  <label htmlFor="contact-message-nl" className="font-mono text-xs text-muted tracking-widest uppercase">Project</label>
                  <textarea
                    id="contact-message-nl"
                    name="message"
                    required
                    rows={5}
                    className="input-line resize-none"
                    style={{ borderBottom: "1px solid #D9D5CC" }}
                    placeholder="Wat wil je bouwen? Geef een korte beschrijving van het project of de uitdaging."
                    disabled={status === "loading"}
                  />
                </div>
        ...
        <div className="lg:col-span-4 lg:col-start-9 flex flex-col gap-12">
          ...
          <div>
            ...
            <p className="text-sm text-secondary leading-relaxed">
              Binnen 24 uur. Voor urgente zaken graag een directe e-mail.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-secondary leading-relaxed mb-6">
              Zowel korte projecten als langere samenwerking.
            </p>
            <a
