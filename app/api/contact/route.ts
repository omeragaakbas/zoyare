        ...
        html: `
          <div style="font-family: monospace; max-width: 600px; margin: 0 auto; padding: 32px; background: #080808; color: #F5F5F5;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
              <tr><td style="padding: 8px 0; color: #888; font-size: 12px; width: 100px;">NAME</td><td style="padding: 8px 0; color: #F5F5F5; font-size: 14px;">${name}</td></tr>
              <tr><td style="padding: 8px 0; color: #888; font-size: 12px;">EMAIL</td><td style="padding: 8px 0;"><a href="mailto:${email}" style="color: #C8FF00; text-decoration: none;">${email}</a></td></tr>
              ${company ? `<tr><td style="padding: 8px 0; color: #888; font-size: 12px;">COMPANY</td><td style="padding: 8px 0; color: #F5F5F5; font-size: 14px;">${company}</td></tr>` : ""}
            </table>
            ...
            <div style="border-top: 1px solid #1C1C1C; margin-top: 32px; padding-top: 16px;">
              <span style="font-size: 11px; color: #444;">Reply directly to this email to respond to ${name}.</span>
            </div>
          </div>
        `,
      }),
      resend.emails.send({
        ...
        html: `
          <div style="font-family: monospace; max-width: 600px; margin: 0 auto; padding: 32px; background: #080808; color: #F5F5F5;">
            ...
            <p style="color: #F5F5F5; font-size: 16px; margin: 0 0 16px;">Hi ${name},</p>
