...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  // Pages touched in the September 2026 search pass. Bump this when their copy changes —
  // a lastModified frozen in the past is why Google stopped recrawling the sitemap before.
  const REVISED = "2026-09-01";

  const enStaticRoutes: MetadataRoute.Sitemap = [
    { url: BASE_URL,                                           lastModified: latestPost,   changeFrequency: "monthly",  priority: 1.0 },
    { url: `${BASE_URL}/software-development-netherlands`,     lastModified: REVISED,      changeFrequency: "monthly",  priority: 0.9 },
    { url: `${BASE_URL}/portfolio`,                            lastModified: "2026-05-27", changeFrequency: "monthly",  priority: 0.8 },
    { url: `${BASE_URL}/about`,                                lastModified: REVISED,      changeFrequency: "yearly",   priority: 0.7 },
    ...
    { url: `${BASE_URL}/faq`,                                  lastModified: REVISED,      changeFrequency: "monthly",  priority: 0.7 },
    { url: `${BASE_URL}/estimate`,                             lastModified: "2026-07-08", changeFrequency: "monthly",  priority: 0.8 },
    { url: `${BASE_URL}/services/custom-software`,             lastModified: REVISED,      changeFrequency: "monthly",  priority: 0.9 },
    { url: `${BASE_URL}/services/api-integrations`,            lastModified: REVISED,      changeFrequency: "monthly",  priority: 0.9 },
    { url: `${BASE_URL}/services/mobile-applications`,         lastModified: REVISED,      changeFrequency: "monthly",  priority: 0.9 },
    { url: `${BASE_URL}/services/process-automation`,          lastModified: REVISED,      changeFrequency: "monthly",  priority: 0.9 },
